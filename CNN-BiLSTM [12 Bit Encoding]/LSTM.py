...
from keras.layers import Dense, Dropout, LSTM, Conv1D, BatchNormalization, MaxPooling1D, Bidirectional
...
X_train,y_train,X_test,y_test = dataset.twelve_bit_encode(X_train_seqs,y_train,X_test_seqs,y_test)

# create the model
model = Sequential()
model.add(Dropout(0.05, input_shape=(497,24)))
