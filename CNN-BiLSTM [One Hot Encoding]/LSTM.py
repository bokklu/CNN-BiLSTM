...
from keras.layers import Dense, Dropout, LSTM, Conv1D, MaxPooling1D, BatchNormalization, Bidirectional, Embedding
...
model.fit(X_train,y_train, validation_data=(X_test,y_test), nb_epoch=2000, batch_size=64, callbacks=callbacks_list, verbose=2)
